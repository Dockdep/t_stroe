            ...
            <div class="col-xs-12">
                ...
                <div class="style radio_custom self-delivery-radio">
                    ...
                    <div class="style hidden-radios_">
                        <div class="style radio_custom">
                            <input type="radio" id="radio-1-4" value="Киев, ул. Гната Хоткевича 22в"  name="OrderFrontend[delivery_address]]">
                            <label for="radio-1-4">Киев, ул. Гната Хоткевича 22в</label>
                        </div>
                        <div class="style radio_custom">
                            <input type="radio" id="radio-1-5" value="Бровары, ул. Лесная 2"  name="OrderFrontend[delivery_address]]">
