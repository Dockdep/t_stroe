<?php
    ...
    class Basket extends Component
    {
        ...
        public function addAnalogs($additionalData)
        {
            $data = $this->getData();
            $count = 1;
            $product_variant_id = (isset($additionalData[0]) && $additionalData[0] != '') ? $additionalData[0]:$additionalData[1];
            ...
            $sku =  (isset($additionalData[6]) && !empty($additionalData[6])) ? $additionalData[6]:"";
            ...
            $data['analogs'][ $product_variant_id ][ 'sku' ] = $sku;
